...
func (m *memStore) RecordHeartbeat(_ context.Context, _ model.ProbeHeartbeat) error {
	return nil
}

func (m *memStore) ListHeartbeats(_ context.Context, _ store.HeartbeatFilter) ([]model.ProbeHeartbeat, error) {
	return nil, nil
}
...
func (m *memStore) UpsertCloudDNSSnapshot(_ context.Context, _ *cloud.DNSSnapshot) error {
	return nil
}
