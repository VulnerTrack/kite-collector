...
func TestLogCodes_FollowConvention(t *testing.T) {
	codes := []LogCode{
		...
		LogCodeTelemetryUserIdentityResolved,
		LogCodeTelemetryEnvelopeConfigured,
		LogCodeTelemetryEnvelopeIdentitySigner,
		LogCodeTelemetrySigningConfigured,
		LogCodeHostMetricsConfigured, LogCodeHostMetricsCollectFailed,
		LogCodeMemorySeriesConfigured, LogCodeMemorySeriesSampleFailed,
		LogCodeHostListenersConfigured, LogCodeHostListenersFailed,
		LogCodeHostMetricsCollectDegraded, LogCodeHostMetricsEmitFailed,
