...
<!-- Generated by `go run ./tools/loginventory/cmd`. Do not edit by hand. -->
...
| Code | Constant | Description |
|---|---|---|
| `agent.upgrade.binary_swap_detected` | `LogCodeBinarySwapDetected` | — |
| `agent.upgrade.relaunch_for_new_binary` | `LogCodeBinarySwapRelaunch` | — |
| `agent.upgrade.binary_missing_on_disk` | `LogCodeBinaryMissing` | — |
