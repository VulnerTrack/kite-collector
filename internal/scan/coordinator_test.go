...
func (s *fakeStore) RecordHeartbeat(_ context.Context, _ model.ProbeHeartbeat) error {
	return nil
}

func (s *fakeStore) ListHeartbeats(_ context.Context, _ store.HeartbeatFilter) ([]model.ProbeHeartbeat, error) {
	return nil, nil
}
