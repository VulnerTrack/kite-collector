...
func buildSourceConfigMap(name string, src config.SourceConfig) map[string]any {
	m := map[string]any{
		...
		// Network web-fingerprint knobs (RFC: in-scan software recognition).
		"web_fingerprint_include_api":        src.WebFingerprintIncludeAPI,
		"web_fingerprint_include_file":       src.WebFingerprintIncludeFile,
		"web_fingerprint_version_disclosure": !src.WebFingerprintDisableVersionDisclosure,
		"web_vhosts":                         stringSliceToAny(src.WebVHosts),
		"host":                               src.Host,
