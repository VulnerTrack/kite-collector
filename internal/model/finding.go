...
type ConfigFinding struct {
	...
	// CWEID + CWEName tag the finding with a MITRE CWE identifier so
	// the dashboard and exports can correlate config weaknesses with
	// the same vulnerability taxonomy used by NVD/CVE feeds. Optional
	// — older auditors that don't classify against CWE leave both
	// empty.
